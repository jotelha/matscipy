...
# define desired system
pnp['fenics_interface'] = PoissonNernstPlanckSystemFEniCSx(c=c, z=z, L=L, delta_u=delta_u, N=N)
...
# %%
pnp['fenics_interface_high_potential'] = PoissonNernstPlanckSystemFEniCSx(c=c, z=z, L=L, delta_u=delta_u, N=200)
