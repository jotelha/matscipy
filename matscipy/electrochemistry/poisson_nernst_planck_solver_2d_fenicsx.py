#
# Copyright 2024 Johannes Hoermann (U. Freiburg)
#
...
Copyright 2024 IMTEK Simulation
...
class PoissonNernstPlanckSystemFEniCSx2d(PoissonNernstPlanckSystem):
    """Describes and solves a 2D Poisson-Nernst-Planck system"""
    ...
    def solve(self):
        ...
        # https://jsdokken.com/dolfinx-tutorial/chapter2/nonlinpoisson_code.html#newtons-method
    ...
    def boundary_n(self, x, on_boundary):
    ...
    def apply_potential_dirichlet_bc(self, u0, ):
    ...
    def discretize(self):
        ...
        P = basix.ufl.element('Lagrange', self.domain.basix_cell(), 3)
        # R = fn.FiniteElement('Real', fn.interval, 0)
        R = basix.ufl.element('Real', self.domain.basix_cell(), 0)
        elements = [P]*(1+self.M) + [R]*self.K
        # elements = basix.ufl.mixed_element([P]*(1+self.M) + [R]*self.K)
